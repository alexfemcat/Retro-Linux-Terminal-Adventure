...
export const MARKET_CATALOG: MarketItem[] = [
    // --- SOFTWARE: Tier 1 ---
    { id: 'ping', name: 'ping', category: 'utility', tier: 1, description: 'Network connectivity tester', cost: 100, cpuReq: 1, ramReq: 4, storageSize: 5 },
    { id: 'nmap-lite', name: 'nmap-lite', category: 'sniffing', tier: 1, description: 'Basic port scanner (Open/Closed only)', cost: 250, cpuReq: 5, ramReq: 16, storageSize: 15 },
    { id: 'brute-force.sh', name: 'brute-force.sh', category: 'exploit', tier: 1, description: 'Basic noisy brute-force script', cost: 400, cpuReq: 20, ramReq: 32, storageSize: 2 },

    // --- SOFTWARE: Tier 2 ---
    { id: 'nmap', name: 'nmap', category: 'sniffing', tier: 2, description: 'Standard network scanner with service detection', cost: 800, cpuReq: 10, ramReq: 64, storageSize: 45 },
    { id: 'hydra', name: 'hydra', category: 'exploit', tier: 2, description: 'Multi-threaded password brute-force tool', cost: 1500, cpuReq: 25, ramReq: 128, storageSize: 30 },
    { id: 'ssh-crack-v1', name: 'ssh-crack-v1', category: 'exploit', tier: 2, description: 'Specialized SSH credential harvester', cost: 2000, cpuReq: 15, ramReq: 96, storageSize: 20 },
    { id: 'overclock', name: 'overclock', category: 'utility', tier: 2, description: 'Unlock CPU frequency controls and voltage scaling.', cost: 1200, cpuReq: 2, ramReq: 8, storageSize: 10 },
