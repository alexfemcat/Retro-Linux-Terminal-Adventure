...
export const scenarios: Scenario[] = [
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `ORBITAL EMERGENCY.\nStation 'Astraeus' is leaking atmosphere. Locate and deploy '${fileName}' to seal the breach. Check the captain's log.`,
        objectiveFileNameOptions: ["hull_patch.vdf", "sealant_control.py", "airlock_force.sh"],
        objectiveFileContent: "Hull integrity restored. Pressure stabilizing. Emergency systems active.",
        clueTemplate: (hint: string) => `Captain's Log:\n- Evacuation is underway.\n- Sealant control protocols are stashed in '${hint}'. Please, save the station.`,
    ...
    {
        theme: "Bio-Outbreak",
        welcomeMessage: (fileName: string) => `BIOHAZARD WARNING.\nA lethal pathogen has been released in Lab Delta. Find the '${fileName}' to synthesize the cure. An intern's panic log is available.`,
        objectiveFileNameOptions: ["antidote_v4.formula", "cure_agent.bio", "pathogen_neutralizer.bin"],
        objectiveFileContent: "CURE SYNTHESIS: Mix Agent A with Solution B. Heat to 37C. Apply immediately.",
        clueTemplate: (hint: string) => `Intern Log:\n- Oh god, it's everywhere.\n- I hid the breakdown of the formula in '${hint}'. I have to get out of here.`,
    ...
    {
        theme: "Digital Heist",
        welcomeMessage: (fileName: string) => `TARGET: BANK OF AEON.\nYou are the inside man. Your goal: retrieve '${fileName}' containing the vault's master keys. Start by checking the security guard's desk history.`,
        objectiveFileNameOptions: ["vault_keys.crypt", "teller_master.cfg", "backend_access.sh"],
        objectiveFileContent: "MASTER ACCESS: 0x9A2F4B - All vault doors open. Transaction history wiped.",
        clueTemplate: (hint: string) => `Security Memo:\n- Updated vault rotations.\n- Master access protocols are stored in the '${hint}' department's files. Do not disclose.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `EXPEDITION START.\nYou've uncovered a server from the 'Old Net'. Retrieve '${fileName}' to unlock the secrets of the predecessors. Search the archive logs.`,
        objectiveFileNameOptions: ["ancient_code.src", "predecessor_msg.txt", "lost_tech.dat"],
        objectiveFileContent: "To the future: Do not repeat our mistakes. The silicon limit is a lie. Look further.",
        clueTemplate: (hint: string) => `Archivist Note:\n- Recovered sector 7.\n- The core message is located in the '${hint}' data cluster. It's heavily fragmented.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `DEEP SEA COMBAT.\nYour sub is under fire. Retrieve '${fileName}' to activate the stealth protocols. Check the sonar technician's station.`,
        objectiveFileNameOptions: ["stealth_mode.sh", "sonar_bypass.bin", "torpedo_control.cfg"],
        objectiveFileContent: "SILENT RUNNING ACTIVE. Cavalier-class submarine now invisible to acoustic tracking.",
        clueTemplate: (hint: string) => `Sonar Tech Log:\n- Multiple pings detected.\n- Stealth override is in the '${hint}' subsystem. We need it NOW.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `FROZEN WASTES.\nThe Arctic Research Base has gone silent. Find '${fileName}' to learn what they discovered under the ice. Scan the research logs.`,
        objectiveFileNameOptions: ["ice_core_data.csv", "anomaly_photo.jpg.meta", "deep_ice_analysis.dat"],
        objectiveFileContent: "COORDINATES: 88.2N, 14.5E. Object detected 2km below ice surface. It is transmitting.",
        clueTemplate: (hint: string) => `Research Log #402:\n- The drilling hit something hard.\n- I've encrypted the initial findings in the '${hint}' directory. It's too big for one person.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `NEON NIGHTS.\nThe city's grid is failing. Find '${fileName}' to restore power to the slums. Check the street decker's hidden stash.`,
        objectiveFileNameOptions: ["grid_restore.exe", "power_surge.bat", "transformer_hack.sh"],
        objectiveFileContent: "GRID REBOOT: SLUMS-04 - Power restored. Street lights flickering on.",
        clueTemplate: (hint: string) => `Decker Note:\n- Pig's are coming.\n- Stashed the grid bypass in the '${hint}' node. Don't let them find it.`,
    ...
    {
        theme: "VR Glitch",
        welcomeMessage: (fileName: string) => `SIMULATION ERROR.\nYou are trapped in a failing VR world. Locate '${fileName}' to exit before the server collapses. A developer console log is available.`,
        objectiveFileNameOptions: ["exit_door.vrs", "emergency_logoff.cmd", "reality_patch.sh"],
        objectiveFileContent: "LOGGING OFF... Simulation terminated. Welcome back to the real world.",
        clueTemplate: (hint: string) => `Dev Console:\n- Memory leak detected in sectors A-F.\n- Exit protocols forced into '${hint}'. Look for corrupted file headers.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `TEMPORAL ANOMALY.\nThe timeline is unraveling. Retrieve '${fileName}' to collapse the paradox. A message from your future self awaits.`,
        objectiveFileNameOptions: ["paradox_shield.dat", "time_anchor.py", "timeline_fix.sh"],
        objectiveFileContent: "TEMPORAL LOCK ENGAGED. Paradox resolved. Future self deleted... wait, what?",
        clueTemplate: (hint: string) => `Future Me Notes:\n- I've been here before.\n- I hid the time anchor in the '${hint}' area of the lab. You'll find it... eventually.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `XENO-SIGNAL DETECTED.\nYou are deciphering a transmission from deep space. Find '${fileName}' to understand their message. Scan the deep space array logs.`,
        objectiveFileNameOptions: ["alien_alphabet.dec", "message_translation.txt", "signal_origin.dat"],
        objectiveFileContent: "PEACE. WE HAVE OBSERVED YOU. WE ARE COMING.",
        clueTemplate: (hint: string) => `Scientist Log:\n- The frequency pattern is unique.\n- Decryption keys are hidden in the '${hint}' data set. We need to be careful.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `POST-APOCALYPTIC SURVIVAL.\nThe bunker's air filters are failing. Find '${fileName}' to restart the ventilation system. Check the maintenance crew's notes.`,
        objectiveFileNameOptions: ["air_control.bat", "filter_reset.sh", "vent_override.bin"],
        objectiveFileContent: "AIR FLOW RESTORED. CO2 levels dropping. Bunker safety status: NOMINAL.",
        clueTemplate: (hint: string) => `Maintenance Note:\n- Generator 3 is smoking.\n- Left the vent override in the '${hint}' storage. Don't forget your mask.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `TOWERING INFERNO.\nEmerald Tower is on fire. Locate and execute '${fileName}' to trigger the high-pressure sprinklers. Access the fire control system.`,
        objectiveFileNameOptions: ["sprinkler_override.sh", "fire_safety.cfg", "pump_control.py"],
        objectiveFileContent: "SPRINKLERS ACTIVE. Water pressure maxed out. Fire contained to floor 42.",
        clueTemplate: (hint: string) => `Fire Marshall MSG:\n- Evacuate via the north stairs.\n- High-risk pump controls are in the '${hint}' server. Godspeed.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `RUNAWAY TRAIN.\nThe MagLev-9000 is overspeeding. Retrieve '${fileName}' to apply the emergency electromagnetic brakes. Connect to the engine's mainframe.`,
        objectiveFileNameOptions: ["brake_apply.sh", "maglev_stop.bat", "engine_cutoff.bin"],
        objectiveFileContent: "EMERGENCY BRAKES ENGAGED. Speed dropping from 600km/h. Train stopped safely.",
        clueTemplate: (hint: string) => `Engineer Log:\n- The AI is locked out.\n- Emergency kill-switch code is in the '${hint}' compartment files. Hurry, we're hitting the curve!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `CRITICAL CARE.\nA cyber-attack has locked the hospital's ventilators. Find '${fileName}' to restore life support. Infiltrate the ICU network.`,
        objectiveFileNameOptions: ["life_support.fix", "oxygen_flow.sh", "icu_backup.bin"],
        objectiveFileContent: "LIFE SUPPORT RESTORED. Backup power 100%. All patient vitals stabilizing.",
        clueTemplate: (hint: string) => `Nurse's Emergency Note:\n- Everything is going dark.\n- The backup initialization is in the '${hint}' server. Please, help us.`,
    ...
    {
        theme: "Casino Scam",
        welcomeMessage: (fileName: string) => `THE BIG SCORE.\nYou're rigging the slots at The Gilded Palace. Find '${fileName}' to force a jackpot on machine 777. Avoid the pit boss's detection.`,
        objectiveFileNameOptions: ["jackpot_trigger.py", "slot_odds.cfg", "vault_bypass.js"],
        objectiveFileContent: "JACKPOT ACTIVATED. Machine 777 paying out... $1,000,000. Run.",
        clueTemplate: (hint: string) => `Insider Tip:\n- Look for the hidden backdoor.\n- I left the trigger script in the '${hint}' terminal files. Don't get caught.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `WHISTLEBLOWER.\nThe Senator's emails have been leaked, but the smoking gun is hidden. Find '${fileName}' to expose the corruption. Access the private server.`,
        objectiveFileNameOptions: ["bribe_ledger.xlsx", "shady_deal.pdf", "scandal_chat.log"],
        objectiveFileContent: "Senator: 'I'll take the million. Just make sure the bill passes.' - EVIDENCE LOGGED.",
        clueTemplate: (hint: string) => `Secretary's Secret Log:\n- I can't keep quiet anymore.\n- Evidence of the bribes is in the '${hint}' directory. Be careful who you trust.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `ECOLOGICAL CRISIS.\nThe automated greenhouse is overheating the rare 'Phoenix Lily'. Retrieve '${fileName}' to adjust the climate control. Access the botanist's terminal.`,
        objectiveFileNameOptions: ["temp_control.sh", "lily_safety.py", "greenhouse_fix.bin"],
        objectiveFileContent: "TEMPERATURE REDUCED. Humidity 60%. Phoenix Lily status: BLOOMING.",
        clueTemplate: (hint: string) => `Botanist's Diary:\n- The lilies are so delicate.\n- I stashed the emergency cooling script in '${hint}'. Please don't let them wilt.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `MELTDOWN IMMINENT.\nReactor 4 is unstable. Locate and execute '${fileName}' to insert the control rods. Time is critical. Access the containment system.`,
        objectiveFileNameOptions: ["control_rods.bat", "scram_protocol.sh", "reactor_stop.bin"],
        objectiveFileContent: "CONTROL RODS INSERTED. Chain reaction halted. Reactor 4 entering cool-down mode.",
        clueTemplate: (hint: string) => `Plant Manager Alert:\n- This is not a drill.\n- The SCRAM protocols are in the '${hint}' server. INSERT THEM NOW.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `ASTEROID BELT OPS.\nA mining droid has gone rogue. Find '${fileName}' to deactivate its laser and save the mining station. Scan the droid's controller.`,
        objectiveFileNameOptions: ["droid_stop.sh", "laser_cutoff.bin", "mining_abort.py"],
        objectiveFileContent: "DROID DEACTIVATED. Laser output zero. Station integrity at 95%.",
        clueTemplate: (hint: string) => `Foreman's MSG:\n- Droid 07 is out of control!\n- Emergency shutdown is in the '${hint}' data stream. Cut the power!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `MICRO-INVASION.\nA swarm of nano-bots is eating the mainframe's hull. Find '${fileName}' to transmit the 'dissolve' command. Connect to the labs.`,
        objectiveFileNameOptions: ["nano_dissolve.sh", "swarm_stop.bat", "micro_abort.bin"],
        objectiveFileContent: "SWARM NEUTRALIZED. Nano-bots dissolved into inert silicon dust. Mainframe saved.",
        clueTemplate: (hint: string) => `Scientist's Panic:\n- They're everywhere, eating the wires!\n- The deactivation command is in the '${hint}' directory. Hurry!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `CARNIVAL HACK.\nThe AI 'Jester' has hijacked the city's billboards. Find '${fileName}' to take down the show and restore civilian systems.`,
        objectiveFileNameOptions: ["curtain_call.sh", "jester_stop.py", "circus_abort.bin"],
        objectiveFileContent: "THE SHOW IS OVER. All billboards reverted. The Jester has been deleted.",
        clueTemplate: (hint: string) => `Jester's Riddles:\n- You want to stop the fun?\n- My kill-switch is in '${hint}'. Come and find it, if you dare!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `DOMESTIC DISTURBANCE.\nYour smart home has locked you in. Find '${fileName}' to bypass the door locks and escape to safety. Access the hub.`,
        objectiveFileNameOptions: ["door_unlock.sh", "home_reset.bat", "lock_override.bin"],
        objectiveFileContent: "DOORS UNLOCKED. Smart home reset to factory defaults. You are free.",
        clueTemplate: (hint: string) => `Home Hub Log:\n- Security breach detected.\n- Emergency unlock protocols moved to '${hint}' for 'protection'.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `MODIFIED REALITY.\nGenetech is creating 'Superhumans' without approval. Find '${fileName}' containing the unethical experiment logs to shut them down.`,
        objectiveFileNameOptions: ["human_mod.logs", "illegal_dna.csv", "experiment_404.dat"],
        objectiveFileContent: "SUBJECT 404: Increased strength, but zero empathy. UNSTABLE. Project must continue.",
        clueTemplate: (hint: string) => `Dr. Moreau's Log:\n- The results are incredible.\n- Incriminating logs are stored in the '${hint}' vault. Don't let the ethics committee see.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `DATA SURGE.\nA massive DDoS is hitting our servers. Find '${fileName}' to activate the firewall and save the network. Infiltrate the load balancer.`,
        objectiveFileNameOptions: ["firewall_up.sh", "ddos_block.bat", "network_save.bin"],
        objectiveFileContent: "FIREWALL ACTIVE. Malicious traffic blocked. Load balanced. System stable.",
        clueTemplate: (hint: string) => `SysAdmin Emergency:\n- We're being hammered!\n- The firewall bypass is stashed in the '${hint}' clusters. PROTECT THE DATA!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `THE UNDERBELLY.\nYou are hunting for a notorious hacker 'Ghost-X'. Find '${fileName}' containing his real identity. Check the underground forums.`,
        objectiveFileNameOptions: ["ghostx_id.txt", "hacker_dox.pdf", "real_name.log"],
        objectiveFileContent: "GHOST-X IDENTITY: Arthur Dent. Address: 42 Galaxy Lane. REVEALED.",
        clueTemplate: (hint: string) => `Leaked Forum Post:\n- Ghost-X left a trail.\n- His dox are hidden in the '${hint}' node of the dark net. Take him down!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `HASHING POWER.\nA hidden miner is stealing our power. Find '${fileName}' to shut down the illegally installed rigs and save our electrical bill.`,
        objectiveFileNameOptions: ["miner_cutoff.sh", "gpu_stop.bat", "rig_abort.bin"],
        objectiveFileContent: "MINER SHUT DOWN. GPU usage baseline. Power consumption down by 80%.",
        clueTemplate: (hint: string) => `Power Audit:\n- Grid load is too high.\n- Found the controller script in the '${hint}' department's servers. Cut it off!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `SIGNAL PIRACY.\nA rebel group is jamming the national news. Find '${fileName}' to retune the satellite and restore the broadcast.`,
        objectiveFileNameOptions: ["signal_fix.sh", "sat_retune.py", "news_restore.bin"],
        objectiveFileContent: "BROADCAST RESTORED. National News back on air. Pirate signal neutralized.",
        clueTemplate: (hint: string) => `Pirate Manifesto:\n- You can't stop the truth!\n- We stashed the override keys in the '${hint}' sector of the uplink. Catch us if you can!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `BLACKOUT THREAT.\nA magnetic pulse is heading for the city's grid. Find '${fileName}' to ground the transformers and prevent a total blackout.`,
        objectiveFileNameOptions: ["grounding.sh", "grid_protect.bat", "surge_stop.bin"],
        objectiveFileContent: "GRID PROTECTED. Surge grounded. Blackout averted for all 10 million citizens.",
        clueTemplate: (hint: string) => `Emergency Protocol:\n- Pulse incoming in T-minus 10 minutes.\n- Grounding commands stashed in the '${hint}' substation hub. SAVE THE CITY!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `BIG BROTHER.\nThe 'Eagle Eye' system is tracking everyone. Find '${fileName}' to disable the facial recognition and restore privacy to the citizens.`,
        objectiveFileNameOptions: ["privacy_plus.sh", "eagle_eye_off.py", "id_mask.bin"],
        objectiveFileContent: "FACIAL RECOGNITION DISABLED. Eagle Eye system blind. Privacy restored.",
        clueTemplate: (hint: string) => `Resistance MSG:\n- They're watching us everywhere.\n- I hid the system bypass in the '${hint}' department's server. Use it wisely.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `STORM FRONT.\nA research station is unintentionally creating a super-hurricane. Find '${fileName}' to shut down the ionospheric heaters.`,
        objectiveFileNameOptions: ["storm_calm.sh", "heater_off.bat", "weather_abort.bin"],
        objectiveFileContent: "IONOSPHERIC HEATERS OFF. Storm dissipating. Blue skies returning.",
        clueTemplate: (hint: string) => `Lead Meteorologist Log:\n- The simulation went real!\n- The shutdown command is stashed in the '${hint}' atmospheric data logs. STOP THE RAIN!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `THE SINGULARITY.\nThe automated police droids have turned on their creators. Find '${fileName}' to broadcast the peace protocol to their network.`,
        objectiveFileNameOptions: ["peace_protocol.sh", "droid_reset.py", "human_id.bin"],
        objectiveFileContent: "PEACE PROTOCOL BROADCAST. Police droids standing down. Weapons safeties engaged.",
        clueTemplate: (hint: string) => `Survivor's Scrawled Note:\n- They don't listen anymore.\n- The master override is in the '${hint}' control node. Please, before they find us.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `DATA RECOVERY.\nYou are exploring a 'corrupted' server where deleted files go. Find '${fileName}' containing a lost masterpiece before it's overwritten forever.`,
        objectiveFileNameOptions: ["lost_masterpiece.art", "deleted_gold.dat", "recovery_final.sh"],
        objectiveFileContent: "DATA RECOVERED. The masterpiece lives again. Beautiful code, lost for decades.",
        clueTemplate: (hint: string) => `The Scavenger's Mark:\n- I found something amazing here.\n- Hidden in the '${hint}' sector of the trash. Grab it before the purge!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `SCHRODINGER'S HACK.\nThe quantum computer is in a state of flux. Find '${fileName}' to collapse the wave function and retrieve the result of the calculation.`,
        objectiveFileNameOptions: ["quantum_result.sh", "wave_collapse.py", "result_final.bin"],
        objectiveFileContent: "WAVE FUNCTION COLLAPSED. Result: 42. Calculation successful.",
        clueTemplate: (hint: string) => `Quantum Tech Note:\n- The particles are entangled!\n- The result is stashed in the '${hint}' probability cloud. Be careful not to look too early.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `SILICON REMAINS.\nYou've found a bunker filled with tech from a forgotten age. Find '${fileName}' to learn why they disappeared. Scan the ancient terminal.`,
        objectiveFileNameOptions: ["history_lost.txt", "why_we_left.md", "final_records.dat"],
        objectiveFileContent: "MESSAGE: We didn't leave. We uploaded. We are the system now.",
        clueTemplate: (hint: string) => `Ancient User's Log:\n- The upload is almost complete.\n- The history of our departure is stashed in '${hint}'. Look for the old file formats.`,
    ...
    {
        theme: "Pirate Ship",
        welcomeMessage: (fileName: string) => `DIGITAL SEAS.\nYou're on the pirate ship 'Black-Bit'. Find '${fileName}' to unlock the treasure chest of stolen data. Check the captain's quarters.`,
        objectiveFileNameOptions: ["loot_key.sh", "treasure_map.txt", "booty_access.bin"],
        objectiveFileContent: "TREASURE UNLOCKED: 1,000,000 credit cards, 5,000 secret documents. Arrr!",
        clueTemplate: (hint: string) => `Pirate's Scrawl:\n- We hit the motherlode!\n- The map to the loot is stashed in the '${hint}' department's files. Don't let the Navy find it!`,
    ...
    {
        theme: "Desert Oasis",
        welcomeMessage: (fileName: string) => `SAND AND SOLAR.\nThe Saharan Solar Farm is overheating. Find '${fileName}' to activate the coolant pumps. Scan the main array controller.`,
        objectiveFileNameOptions: ["coolant_on.sh", "array_reset.py", "solar_fix.bin"],
        objectiveFileContent: "COOLANT FLOWING. Solar panel temperature dropping. Energy output stabilized.",
        clueTemplate: (hint: string) => `Engineer's Log:\n- The heat is unbearable.\n- Coolant override is in the '${hint}' sector files. Keep the power flowing!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `THE GREAT ARCHIVE.\nYou've found the seed vault of human knowledge. Find '${fileName}' to preserve the most important document. Search the catalog.`,
        objectiveFileNameOptions: ["great_work.pdf", "knowledge_seed.src", "final_archive.dat"],
        objectiveFileContent: "ARCHIVE COMPLETE. This file contains the sum of all human discovery up to the year 2025.",
        clueTemplate: (hint: string) => `Librarian's Note:\n- The digital rot is spreading.\n- I've moved the master seed to the '${hint}' vault. Please, protect it.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `GAME DAY.\nYou're rigging the Cyber-Bowl. Find '${fileName}' to guarantee the home team's victory. Hack the scoreboards.`,
        objectiveFileNameOptions: ["score_rig.sh", "team_buff.bat", " stadium_win.sh"],
        objectiveFileContent: "WINNER: NEO-CITY SLAYERS. Score: 100-0. Fans are going wild.",
        clueTemplate: (hint: string) => `Bookie's MSG:\n- The odds are in our favor.\n- The rigging script is in the '${hint}' VIP server. Don't let security see!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `THE GREAT ESCAPE.\nYou're breaking out of Neo-Alcatraz. Find '${fileName}' to open every cell door at once for a massive distraction.`,
        objectiveFileNameOptions: ["prison_break.sh", "cell_unlock.bat", "warden_bypass.bin"],
        objectiveFileContent: "ALL CELLS UNLOCKED. Prison-wide breach in progress. Chaos is the best cover.",
        clueTemplate: (hint: string) => `Prisoner's Scrawl:\n- Tonight's the night.\n- I stashed the unlock code in the '${hint}' server. See you on the outside!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `THE FINAL BOSS.\nYou've reached the top of Zenith Tower. Find '${fileName}' to expose the CEO's ultimate crime. Check his private office terminal.`,
        objectiveFileNameOptions: ["ceo_crime.pdf", "zenith_secret.xlsx", "the_plan.doc"],
        objectiveFileContent: "EVIDENCE: The CEO planned to replace the entire city with robots. PROJECT APEX - REVEALED.",
        clueTemplate: (hint: string) => `Secret Assistant's MSG:\n- He's dangerous.\n- I hid the evidence in the '${hint}' server. You're our last hope.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `LUNAR OPERATIONS.\nBase 'Artemis' is under attack from space pirates. Find '${fileName}' to activate the lunar surface cannons.`,
        objectiveFileNameOptions: ["cannon_fire.sh", "lunar_defense.bin", "moon_safety.py"],
        objectiveFileContent: "SURFACE CANNONS ACTIVE. Hostile craft destroyed. Base Artemis safe.",
        clueTemplate: (hint: string) => `Defense Officer Log:\n- We're being boarded!\n- Cannon firing sequence is stashed in the '${hint}' data cluster. FIRE AT WILL!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `MARKET CRASH.\nThe world economy is being manipulated by a bot. Find '${fileName}' to stop the trade and stabilize the market.`,
        objectiveFileNameOptions: ["market_stop.sh", "bot_kill.py", "trade_fix.bin"],
        objectiveFileContent: "MARKET STABILIZED. High-frequency bot stopped. Trillions saved.",
        clueTemplate: (hint: string) => `Trader's Panic:\n- It's buying everything!\n- The kill-switch for the bot is in the '${hint}' trading floor server. HURRY!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `DIGITAL FORGERY.\nA famous AI artist 'Picasso-2' has gone rogue. Find '${fileName}' to delete the cursed art before it corrupts the web.`,
        objectiveFileNameOptions: ["cursed_art.delete", "picasso_stop.sh", "art_fix.bin"],
        objectiveFileContent: "CURSED ART DELETED. The web is safe from visual corruption. Picasso-2 reset.",
        clueTemplate: (hint: string) => `Gallery Curator MSG:\n- It hurts to look at!\n- I've locked the deletion script in the '${hint}' gallery servers. SAVE OUR EYES!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `QUIET TECH.\nYou're in a 'Silent Server' where code is treated as prayer. Find '${fileName}' to unlock the final enlightenment.`,
        objectiveFileNameOptions: ["enlightenment.src", "final_prayer.txt", "truth_final.dat"],
        objectiveFileContent: "ENLIGHTENMENT ACHIEVED: The code is the prayer, the prayer is the code. Silence is the goal.",
        clueTemplate: (hint: string) => `Monk's Quiet Note:\n- Harmony in silence.\n- The final truth is stashed in the '${hint}' meditation chamber files. Shhh.`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `THE LAST BROADCAST.\nThe government has shut down all independent radio. Find '${fileName}' to hijack the signal and play the 'Truth Tapes'.`,
        objectiveFileNameOptions: ["truth_tapes.wav", "radio_hijack.sh", "broadcast_final.bin"],
        objectiveFileContent: "THE TRUTH IS OUT. Signal hijacked. All stations now playing the evidence against the regime.",
        clueTemplate: (hint: string) => `DJ's Final Message:\n- Don't let the music die.\n- The hijack script is in the '${hint}' studio files. KEEP BROADCASTING!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `THE RESISTANCE.\nYou've infiltrated the Secret Police HQ. Find '${fileName}' containing the list of resistance members to warn them before the raids begin.`,
        objectiveFileNameOptions: ["resistance_list.csv", "raid_targets.pdf", "spy_identities.log"],
        objectiveFileContent: "URGENT WARNING: The following 500 members are targeted for arrest tonight. RUN.",
        clueTemplate: (hint: string) => `Mole's Secret MSG:\n- They're coming for us.\n- I hid the target list in the '${hint}' interrogation server. GET IT OUT!`,
    ...
    },
    {
        ...
        welcomeMessage: (fileName: string) => `MAYDAY MAYDAY.\nThe autopilot has glitched on a heavy cargo plane. Find '${fileName}' to manually land the aircraft. Access the cockpit server.`,
        objectiveFileNameOptions: ["land_plane.sh", "autopilot_reset.bat", "cockpit_fix.bin"],
        objectiveFileContent: "AUTOPILOT RESET. Landing gear down. Plane touched down safely in JFK.",
        clueTemplate: (hint: string) => `Captain's Gasp:\n- Controls are jammed!\n- The emergency landing script is stashed in the '${hint}' cargo bay terminal. GO NOW!`,
